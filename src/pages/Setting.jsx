    ...
    <MainLayout>
        ...
        <div className="bg-white p-6 md:p-8 rounded-[25px]">
            ...
            <div className="flex border-b border-[#F4F5F7] max-[425px]:justify-center gap-14 md:gap-14">
                ...
                >
                  Edit Profile
                  {activeTab === 'editProfile' && <span className="absolute -bottom-2 md:bottom-0 left-0 w-full h-0.75 bg-[#1A16F3] rounded-t-lg"></span>}
                </button>
                <button 
                ...
                >
                  Preference
                  {activeTab === 'preferences' && <span className="absolute -bottom-2 md:bottom-0 left-0 w-full h-0.75 bg-[#1A16F3] rounded-t-lg"></span>}
                </button>
                <button 
                ...
                >
                  Security
                  {activeTab === 'security' && <span className="absolute -bottom-2 md:bottom-0 left-0 w-full h-0.75 bg-[#1A16F3] rounded-t-lg"></span>}
                </button>
            </div>
